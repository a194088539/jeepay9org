package org.jeepay.mch.paydemo.ctrl;
...
import org.jeepay.core.common.util.HttpClient;
import org.jeepay.core.common.util.PayDigestUtil;
import org.jeepay.core.entity.MchInfo;
import org.jeepay.mch.common.config.MainConfig;
    ...
    public ResponseEntity<?> create(HttpServletRequest request) {
        ...
        if("SUCCESS".equals(retObj.get("retCode"))) {
            ...
            if(checkSign.equals(retSign)) {
                return ResponseEntity.ok(JeePayPageRes.buildSuccess(retObj));
            }else {
