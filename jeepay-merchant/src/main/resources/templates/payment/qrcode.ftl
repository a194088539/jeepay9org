...
<head>
	...
	@font-face
	{
	    ...
	    src: url(/images/Shiszhongheijt.ttF);
	    font-weight:bold;
	}
        .wrapper {
            /* width: 100%; */
        ...
        .lightB {
            background-color: #02d5c1 !important;
        }
        .darkB {
    ...
    <div class="jianpan">
        ...
        <table>
            <tr>
                ...
                <td class="commC">2</td>
                <td class="commC">3</td>
                <td class="del"><img src="/images/del.png" width="32px" height="32px" alt="删除"></td>
            </tr>
            <tr>
                <td class="commC">4</td>
                <td class="commC">5</td>
        ...
        WeixinJSBridge.invoke(
                ...
                function(res){
                    if(res.err_msg == "get_brand_wcpay_request:ok" ) {
                        ...
                        //回到用户订单列表
                        window.location.href="http://mch.maizoy.com/wechat/order/orderlist";
