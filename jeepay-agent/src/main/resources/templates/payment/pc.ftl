...
<div class="main clearfix">
    ...
    <div class="pay-content">
        ...
        <dl class="pay-list">
            <dt>支付方式</dt>
            <dd>
                <#list channelIds as channelId>
                    <a id="${channelId}" data-pmtprodcode="${channelId}" data-mchId="${mchId!}" data-appId="${appId!}" data-passageId="${passageId!}" data-goodsId="${goodsId!}" data-goodsName="${goodsName!}" data-channelId="${channelId!}" data-amount="${amount!}" target="_blank">
                        <span>
                            <img src="/images/img_${channelId}.png" alt="${channelId}">
                        </span>
                    </a>
                </#list>
            </dd>
...
<div id="pop-wxpay-native" class="pop-layer pop-wx wxpay_native" style="display:none">
    <div class="pop-tit">
        <h5>微信扫一扫付款</h5>
...
<div id="pop-swiftpay-wxpay-native" class="pop-layer pop-wx swiftpay_wxpay_native" style="display:none">
    <div class="pop-tit">
        <h5>微信扫一扫付款</h5>
        <button class="cls-btn">关闭</button>
    </div>
...
<div id="pop-alipay-native" class="pop-layer pop-zfb ali_pay_scan clearfix">
    <div class="pop-tit">
        <h5>支付宝扫一扫付款</h5>
        <button class="cls-btn">关闭</button>
    </div>
...
<div id="pop-swiftpay-alipay-native" class="pop-layer pop-zfb swiftpay_alipay_native clearfix">
    <div class="pop-tit">
        <h5>支付宝扫一扫付款</h5>
        <button class="cls-btn">关闭</button>
    </div>
...
<div class="footer clearfix">©2022 JeePay聚合支付</div>
...
<form id="payComplete" style="display: none" method="post" action="/api/payment/pc_complete">
    <input id="tradeOrderId" name="tradeOrderId" type="hidden" value="">
