...
// 上报订单状态
function serverReport(reqUrl, tradeNo, orderProcess){
    var reqData = {
        'tradeNo': tradeNo,
        'cityInfo': JSON.stringify(getCityInfo()),
        'browerInfo': JSON.stringify(getDeviceInfo()),
        'processStatus': orderProcess
    };
    $.ajax({
        url: reqUrl,
        asyn:true,
...
function getDeviceInfo(){
    ...
    //var info =  JSON.stringify(returnCitySN) + "_" + md.mobile() +  "_" + navigator.userAgent;
