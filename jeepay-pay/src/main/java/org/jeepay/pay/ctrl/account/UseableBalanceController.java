...
public class UseableBalanceController {
    ...
    public String recharge(@RequestParam String params) {
        ...
        try {
            ...
            if(obj == null) return JEEPayUtil.makeRetFail(JEEPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户可用余额变更失败", null, PayEnum.ERR_0010.getCode(), "账户可用余额变更失败"));
            ...
            if(result != 1) {
                return JEEPayUtil.makeRetFail(JEEPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户可用余额变更失败", null, PayEnum.ERR_0010.getCode(), "DB操作失败"));
            }
