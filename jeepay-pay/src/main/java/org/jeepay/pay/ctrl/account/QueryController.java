...
public class QueryController {
    ...
    private final MyLog _log = MyLog.getLog(QueryController.class);
     ...
     * @return
     */
    @RequestMapping(value = "/api/account/query")
    public String query(@RequestParam String params) {
        _log.info("###### 开始接收查询账户请求 ######");
        String logPrefix = "【查询账户】";
        ...
        try {
            ...
            if(userObj == null) return JEEPayUtil.makeRetFail(JEEPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付中心查询账户失败", null, PayEnum.ERR_0010.getCode(), "查询账户失败"));
