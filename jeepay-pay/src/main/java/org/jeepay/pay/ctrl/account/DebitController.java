...
public class DebitController {
    ...
    public String recharge(@RequestParam String params) {
        ...
        try {
            ...
            if(obj == null) return JEEPayUtil.makeRetFail(JEEPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户扣款失败", null, PayEnum.ERR_0010.getCode(), "账户扣款失败"));
            ...
            if(result != 1) {
                return JEEPayUtil.makeRetFail(JEEPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户扣款失败", null, PayEnum.ERR_0010.getCode(), "DB操作失败"));
            }
