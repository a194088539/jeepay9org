...
public class AccountController {
    ...
    public String amountUpdate(@RequestParam String params) {
        ...
        try {
            ...
            if(obj == null) return JEEPayUtil.makeRetFail(JEEPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户金额修改失败", null, PayEnum.ERR_0010.getCode(), "账户金额修改失败"));
            ...
            if(result != 1) {
                return JEEPayUtil.makeRetFail(JEEPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户金额修改失败", null, PayEnum.ERR_0010.getCode(), "DB操作失败"));
            }
            ...
            _log.error(e, "");
            return JEEPayUtil.makeRetFail(JEEPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付中心系统异常", null, e.getRetEnum().getCode()+"", "请联系技术人员查看"));
        }catch (Exception e) {
            _log.error(e, "");
