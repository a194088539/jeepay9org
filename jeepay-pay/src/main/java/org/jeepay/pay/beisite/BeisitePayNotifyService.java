...
@Service
public class BeisitePayNotifyService extends BasePayNotify {
    private final static String logPrefix = "【贝斯特回调】";
    @Override
    ...
    public boolean verifyPayParams(JSONObject payContext,String backSign) {
        // 查询payOrder记录
        String payOrderId = payContext.getString("out_order_id");
...
//        if(!payContext.getString("responseState").equals("1")){
...
//        }
        ...
        // 核对金额
        long outPayAmt = Util.conversionCentAmount(payContext.getBigDecimal("price"));
