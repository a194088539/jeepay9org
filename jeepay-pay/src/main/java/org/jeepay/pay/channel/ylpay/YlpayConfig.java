...
@Component
public class YlpayConfig {
    public static final String CHANNEL_NAME = "ylpay";
    public static final String CHANNEL_NAME_PAY = CHANNEL_NAME + "_pay";
    public static final String CHANNEL_NAME_GATHER = CHANNEL_NAME + "_gather";
    public static final String CHANNEL_NAME_BATCH_GATHER = CHANNEL_NAME + "_batch_gather";
    ...
    public YlpayConfig(String payParam) {
