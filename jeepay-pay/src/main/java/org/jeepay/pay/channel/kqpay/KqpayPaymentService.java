...
public class KqpayPaymentService extends BasePayment {
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        String pageUrl = kqpayConfig.transformUrl(payConfig.getReturnUrl(getChannelName()));
        //服务器接收支付结果的后台地址，该参数务必填写，不能为空。
        String bgUrl = kqpayConfig.transformUrl(payConfig.getNotifyUrl(getChannelName()));
        //网关版本，固定值：v2.0,该参数必填。
        String version =  "v2.0";
        ...
        String privateCertFilePath = payConfig.getCertRootPath() + File.separator + getChannelName() + File.separator + kqpayConfig.getPrivateCertPath();
        String publicCertFilePath = payConfig.getCertRootPath() + File.separator + getChannelName() + File.separator + kqpayConfig.getPublicCertPath();
        ...
        // 支付链接地址
        retObj.put("payUrl", kqpayConfig.getReqUrl());
        // 支付跳转方法
        retObj.put("payAction", "POST");
        // 支付参数
        retObj.put("payParams", object);
