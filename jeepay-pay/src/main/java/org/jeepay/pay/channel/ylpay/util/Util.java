...
import org.jeepay.pay.channel.ylpay.YlpayConfig;
...
public class Util {
	...
	public static String signANDencrypt(MsgBean req_bean,YlpayConfig ylpayConfig) {
	...
	public static MsgBean decryptANDverify(String res, YlpayConfig ylpayConfig) {
