package org.jeepay.core.common.enumm;
...
public enum RetEnum {
    ...
    RET_BIZ_ACCOUNT_NOT_EXIST("1006", "用户账户不存在"),
    RET_BIZ_ACCOUNT_ALLREADY_FROZEN("1007", "用户账户被冻结"),
    RET_BIZ_ACCOUNT_CHECKSUM_ERROR("1008", "帐户校验码校验失败"),
    RET_BIZ_ACCOUNT_BALANCE_NOT_ENOUGH("1009", "帐户余额不足"),
    RET_BIZ_ACCOUNT_CANT_TRANSGER_TO_SELF("1010", "用户不能给自己转账"),
    RET_BIZ_ACCOUNT_USEABLE_BALANCE_NOT_ENOUGH("1011", "帐户可用余额不足"),
