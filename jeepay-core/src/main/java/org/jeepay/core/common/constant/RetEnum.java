...
public enum RetEnum {
    ...
    RET_COMM_RES_PARSE_ERROR(10998, "外部接口响应参数解析错误"),
    ...
    RET_SERVICE_CHANNEL_NOT_BANK(110220, "当前渠道不支持传入的银行编码"),
    ...
    RET_MCH_SETTLEMENT_ACCOUNTNO_REPEAT(12056, "商户申请有重复记录"),
    RET_MCH_SETTLEMENT_INTERVAL_SHORT(12057, "商户申请过于频繁"),
    ...
    RET_MGR_FREQUENT_OPERATION(13020, "操作频繁"),
