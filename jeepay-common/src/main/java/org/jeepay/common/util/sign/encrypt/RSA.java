...
public class RSA{
	 ...
	 * @throws Exception
	 */
	public static byte[] sign(byte[] plainBytes, PrivateKey privateKey, String signAlgorithm) throws Exception {
		try {
	...
	*/
	public static String sign(String content, PrivateKey privateKey ,String characterEncoding){
        return sign(content, privateKey, ALGORITHM, characterEncoding);
    }
	...
	*/
	public static boolean verify(String content, String sign, String publicKey, String signAlgorithms, String characterEncoding){
		try {
	        PublicKey pubKey 		= getPublicKey(publicKey, ALGORITHM, characterEncoding);
			Signature signature = Signature.getInstance(signAlgorithms);
	...
	/**
	 * RSA验签名检查（对数字签名值的16进制字符校验，不是base64编码）
	 * @param content 待签名数据
	 * @param sign 16进制的签名值，不是base64编码
	 * @param  publicKey 公钥
	 * @param signAlgorithms 签名算法
	 * @param characterEncoding 编码格式
	 * @return 布尔值
	 */
	public static boolean verify(String content, byte[] sign, String publicKey, String signAlgorithms, String characterEncoding){
		try {
	...
	*/
	...
	public static boolean verify(byte[] contentBytes, String sign, PublicKey publicKey) {
		try {
	...
	*/
	...
	public static PublicKey getPublicKey(String key, String signAlgorithms, String charset) throws Exception {
		return getPublicKey(new ByteArrayInputStream(key.getBytes(charset)), signAlgorithms);
	}
