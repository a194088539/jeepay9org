...
//                hs = hs + "0" + stmp;
    ...
    public static final BigDecimal conversionYuanAmount(Long amount) {
        return BigDecimal.valueOf(amount).divide(new BigDecimal(100)).setScale(2, BigDecimal.ROUND_HALF_UP);
    }

    public static final BigDecimal conversionYuanAmount(Long amount, int scale) {
        return BigDecimal.valueOf(amount).divide(new BigDecimal(100)).setScale(scale, BigDecimal.ROUND_HALF_UP);
    }
